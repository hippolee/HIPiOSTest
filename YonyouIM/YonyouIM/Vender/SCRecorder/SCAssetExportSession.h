...
typedef void(^SCAssetExportSessionExportCompleteBlock)(BOOL result,  NSError * _Nonnull exportError);
 ...
 */
- (void)exportAsynchronouslyWithCompletionHandler:(__nonnull SCAssetExportSessionExportCompleteBlock)completionHandler;

 ...
 * These come from the underlying logging macros defined in YMDDLog.h.
...
**/
@interface YMDDContextWhitelistFilterLogFormatter : NSObject <YMDDLogFormatter>
...
**/
@interface YMDDContextBlacklistFilterLogFormatter : NSObject <YMDDLogFormatter>

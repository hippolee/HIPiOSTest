...
@interface YMDDMultiFormatter ()

- (YMDDLogMessage *)logMessageForLine:(NSString *)line originalMessage:(YMDDLogMessage *)message;

@end


@implementation YMDDMultiFormatter {
...
- (NSString *)formatLogMessage:(YMDDLogMessage *)logMessage {
    ...
    dispatch_sync(_queue, ^{
        for (id<YMDDLogFormatter> formatter in _formatters) {
            YMDDLogMessage *message = [self logMessageForLine:line originalMessage:logMessage];
...
- (YMDDLogMessage *)logMessageForLine:(NSString *)line originalMessage:(YMDDLogMessage *)message {
    YMDDLogMessage *newMessage = [message copy];

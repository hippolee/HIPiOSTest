#import "YMDDContextFilterLogFormatter.h"
...
@interface YMDDLoggingContextSet : NSObject
...
@implementation YMDDContextWhitelistFilterLogFormatter
{
    YMDDLoggingContextSet *contextSet;
}
...
- (id)init
{
    if ((self = [super init]))
    {
        contextSet = [[YMDDLoggingContextSet alloc] init];
    }
    return self;
}
...
@implementation YMDDContextBlacklistFilterLogFormatter
{
    YMDDLoggingContextSet *contextSet;
}
...
@implementation YMDDLoggingContextSet
{
    OSSpinLock lock;
    NSMutableSet *set;
}

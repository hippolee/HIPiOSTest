 ...
 * 
 * A typical NSLog (or YMDDTTYLogger) prints detailed info as [<process_id>:<thread_id>].
 * For example:
 * 
...
**/
@interface YMDDDispatchQueueLogFormatter : NSObject <YMDDLogFormatter> {
@protected
...
/**
 * Method declarations that make it easier to extend/modify YMDDDispatchQueueLogFormatter
**/
@interface YMDDDispatchQueueLogFormatter (OverridableMethods)

...
@interface YMDDTTYLogger : YMDDAbstractLogger <YMDDLogger>
{
    NSCalendar *calendar;
...
/* Inherited from the YMDDLogger protocol:
 * 
 ...
 * 
 * The actual implementation of these methods is inherited from YMDDAbstractLogger.
 ...
 * 
 * If you run the application from a shell, then YMDDTTYLogger will automatically map the given color to
...
/**
 * Similar to the methods above, but allows you to map YMDDLogMessage->tag to a particular color profile.
 * For example, you could do something like this:
 * 
 * static NSString *const PurpleTag = @"PurpleTag";
 * 
 * #define YMDDLogPurple(frmt, ...) LOG_OBJC_TAG_MACRO(NO, 0, 0, 0, PurpleTag, frmt, ##__VA_ARGS__)
 * 
 ...
 * 
 * [[YMDDTTYLogger sharedInstance] setForegroundColor:purple backgroundColor:nil forTag:PurpleTag];
 * [YMDDLog addLogger:[YMDDTTYLogger sharedInstance]];
 * 
 * This would essentially give you a straight NSLog replacement that prints in purple:
 * 
 * YMDDLogPurple(@"I'm a purple log message!");
**/
#if TARGET_OS_IPHONE

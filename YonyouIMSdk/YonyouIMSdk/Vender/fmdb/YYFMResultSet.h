...
/** `YYFMStatement` used by result set. */
...
/** Create result set from `<FMStatement>`
 ...
 @return A `YYFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(YYFMStatement *)statement usingParentDatabase:(YYFMDatabase*)aDB;

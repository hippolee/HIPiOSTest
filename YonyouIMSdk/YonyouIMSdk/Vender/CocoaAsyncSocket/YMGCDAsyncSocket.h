...
@class YMGCDAsyncReadPacket;
@class YMGCDAsyncWritePacket;
@class YMGCDAsyncSocketPreBuffer;

extern NSString *const YMGCDAsyncSocketException;
extern NSString *const YMGCDAsyncSocketErrorDomain;

extern NSString *const YMGCDAsyncSocketQueueName;
extern NSString *const YMGCDAsyncSocketThreadName;

extern NSString *const YMGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const YMGCDAsyncSocketUseCFStreamForTLS;
#endif
#define YMGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define YMGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define YMGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const YMGCDAsyncSocketSSLPeerID;
extern NSString *const YMGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const YMGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const YMGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const YMGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const YMGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const YMGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define YMGCDAsyncSocketLoggingContext 65535


enum YMGCDAsyncSocketError
{
	YMGCDAsyncSocketNoError = 0,           // Never used
	YMGCDAsyncSocketBadConfigError,        // Invalid configuration
	YMGCDAsyncSocketBadParamError,         // Invalid parameter was passed
	YMGCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	YMGCDAsyncSocketReadTimeoutError,      // A read operation timed out
	YMGCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	YMGCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	YMGCDAsyncSocketClosedError,           // The remote peer closed the connection
	YMGCDAsyncSocketOtherError,            // Description provided in userInfo
};
typedef enum YMGCDAsyncSocketError YMGCDAsyncSocketError;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

@interface YMGCDAsyncSocket : NSObject

/**
 * YMGCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, YMGCDAsyncSocket will automatically create it's own socket queue.
 ...
 * 
 * For accepting incoming connections, this means YMGCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means YMGCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, YMGCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, YMGCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of YMGCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a YMGCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a YMGCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that YMGCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - YMGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So YMGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - YMGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default YMGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct YMGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, YMGCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by YMGCDAsyncSocket,
 ...
 *
 * - YMGCDAsyncSocketSSLProtocolVersionMin
 * - YMGCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - YMGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - YMGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - YMGCDAsyncSocketSSLCipherSuites
 ...
 *
 * - YMGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see YMGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use YMGCDAsyncSocketSSLProtocolVersionMin & YMGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * YMGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(YMGCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(YMGCDAsyncSocket *)sock didAcceptNewSocket:(YMGCDAsyncSocket *)newSocket
 * {
 ...
 * Example usage:
 * 
 * - (void)socket:(YMGCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol YMGCDAsyncSocketDelegate
@optional
...
**/
- (void)socket:(YMGCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(YMGCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(YMGCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(YMGCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(YMGCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the YMGCDAsyncSocket instance is deallocated while it is still connected,
 ...
 * - YMGCDAsyncSocketManuallyEvaluateTrust == YES
 *
...
**/
- (void)socket:(YMGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust

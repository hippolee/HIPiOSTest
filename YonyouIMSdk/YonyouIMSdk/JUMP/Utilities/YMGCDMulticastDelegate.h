...
@class YMGCDMulticastDelegateEnumerator;
 ...
 * 
 * This allows multiple delegates to be added to an jump stream or any jump module,
...
@interface YMGCDMulticastDelegate : NSObject
...
@interface YMGCDMulticastDelegateEnumerator : NSObject

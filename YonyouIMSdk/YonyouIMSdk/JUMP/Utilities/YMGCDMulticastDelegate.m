...
@interface YMGCDMulticastDelegateNode : NSObject {
@private
...
@interface YMGCDMulticastDelegate ()
{
...
@interface YMGCDMulticastDelegateEnumerator ()
{
    NSUInteger numNodes;
...
@implementation YMGCDMulticastDelegate

- (id)init
{
    if ((self = [super init]))
    {
        delegateNodes = [NSMutableArray array];
    }
    return self;
}
...
- (void)addDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    YMGCDMulticastDelegateNode *node =
    [[YMGCDMulticastDelegateNode alloc] initWithDelegate:delegate delegateQueue:delegateQueue];
    @synchronized(self) {
...
- (void)removeDelegate:(id)delegate delegateQueue:(dispatch_queue_t)delegateQueue
{
    ...
    @synchronized(self) {
        ...
        {
            YMGCDMulticastDelegateNode *node = [delegateNodes objectAtIndex:(i-1)];
            ...
            if (delegate == nodeDelegate)
            {
                ...
                {
                    // Recall that this node may be retained by a YMGCDMulticastDelegateEnumerator.
...
{
    @synchronized(self) {
        for (YMGCDMulticastDelegateNode *node in delegateNodes)
        {
            node.delegate = nil;
#if __has_feature(objc_arc_weak) && !TARGET_OS_IPHONE
...
- (YMGCDMulticastDelegateEnumerator *)delegateEnumerator
{
    return [[YMGCDMulticastDelegateEnumerator alloc] initFromDelegateNodes:delegateNodes];
}
...
@implementation YMGCDMulticastDelegateNode
...
@implementation YMGCDMulticastDelegateEnumerator
...
- (BOOL)getNextDelegate:(id *)delPtr delegateQueue:(dispatch_queue_t *)dqPtr
{
    ...
    {
        YMGCDMulticastDelegateNode *node = [delegateNodes objectAtIndex:currentNodeIndex];
        currentNodeIndex++;
